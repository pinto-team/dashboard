...
import {CreateBrandRequest} from "@/features/brand/model/types.ts";
import BrandLogoUploader from '@/features/brand/components/BrandLogoUploader'
            ...
            <Card className="overflow-hidden shadow-sm">
                ...
                <CardContent className="grid gap-6 p-6 md:grid-cols-2">
                    <div className="flex flex-col gap-4">
                        <div>
                            <Label htmlFor="brand-name">{t('brand.form.name')}*</Label>
                            <Input
                                id="brand-name"
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div>
                                <Label htmlFor="brand-country">{t('brand.form.country')}</Label>
                                <Input
                                    id="brand-country"
                            ...
                            <div>
                                <Label htmlFor="brand-website">{t('brand.form.website')}</Label>
                                <Input
                                    id="brand-website"
                    ...
                    <div className="flex flex-col">
                        <BrandLogoUploader
                            ...
                            label={t('brand.form.logo')}
                            aspect="square"
                            className="h-56 w-full self-start"
                        />
                        <p className="mt-2 text-xs text-muted-foreground">
                            {t('brand.form.logo_help')}
                        </p>
                    </div>
                </CardContent>
            </Card>
