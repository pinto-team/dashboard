...
import CategorieForm from '@/features/categories/components/CategorieForm'
import type { CreateCategorieRequest } from '@/features/categories/model/types'
import { AppSidebar } from '@/features/sidebar/app-sidebar'
import { useI18n } from '@/shared/hooks/useI18n'
import { isRTLLocale } from '@/shared/i18n/utils'
import { categoriesQueries } from '@/features/categories'

const FORM_ID = 'categorie-form'

export default function AddCategoriePage(): JSX.Element {
const navigate = useNavigate()
const { t, locale } = useI18n()
const rtl = isRTLLocale(locale)

// mutation (envelope-aware: returns CategorieData)
...
function handleSubmit(values: CreateCategorieRequest) {
setApiErrors([])

createMutation.mutate(values, {
onSuccess: () => {
toast.success(t('categorie.saved_success') ?? 'Categorie saved successfully')
navigate(ROUTES.CATEGORIE.NEW)
},
onError: (err) => {
